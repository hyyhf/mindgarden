<div align="center">
  <h1>🌌 Mind Garden</h1>
  <p>A private, user-governed reflection garden for DeepSeek Harness.</p>
  <p>
    <a href="https://github.com/hyyhf/mindgarden/actions/workflows/verify.yml"><img alt="Verify" src="https://github.com/hyyhf/mindgarden/actions/workflows/verify.yml/badge.svg"></a>
    <a href="LICENSE"><img alt="MIT License" src="https://img.shields.io/github/license/hyyhf/mindgarden?style=flat-square"></a>
    <img alt="DeepSeek Harness plugin" src="https://img.shields.io/badge/DeepSeek%20Harness-plugin-4B6BFB?style=flat-square">
    <img alt="Node.js 22.19 or newer" src="https://img.shields.io/badge/Node.js-%5E22.19%20%7C%7C%20%3E%3D24-339933?style=flat-square&logo=nodedotjs&logoColor=white">
    <img alt="AES-256-GCM encrypted records" src="https://img.shields.io/badge/private%20records-AES--256--GCM-6F42C1?style=flat-square">
  </p>
  <p>English · <a href="README.zh.md">中文</a></p>
</div>

Mind Garden is an installable companion-dialogue and private-reflection workspace for DeepSeek Harness Web. It combines a calm, model-visible dialogue posture with nine user-owned garden spaces, authenticated encryption, governed memory, original Fun Garden migration, and high-fidelity 3D and particle scenes without replacing Harness Sessions, providers, credentials, or plugin lifecycle.

![A real DeepSeek-V4-Flash companion turn in Mind Garden](assets/mind-garden-real-companion.png)

The screenshot above comes from the repository's opt-in real-provider end-to-end test. The reply was generated by `deepseek-v4-flash` through the shipped DeepSeek adapter, then passed through the Mind Garden safety boundary and rendered by the real Web composition.

![The centered Today orrery in the same real DeepSeek Harness session](assets/mind-garden-real-today.png)

The same live run enters Mind Garden, saves an open question through the installed Host service, and renders the Today orrery inside the actual Harness shell. Its six records occupy an implied orbit around a clear center: sparse calibration marks preserve depth without axes or connector curves crossing the reflection prompt.
