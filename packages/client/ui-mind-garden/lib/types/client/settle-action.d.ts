 ...
 */
export declare function settleMindGardenAction<T>(operation: () => Promise<MindGardenDataResult<T>>): Promise<MindGardenDataResult<T>>;
//# sourceMappingURL=settle-action.d.ts.map