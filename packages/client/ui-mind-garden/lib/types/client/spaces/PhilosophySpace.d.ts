...
type PhilosophyActions = Pick<MindGardenViewActions, 'onListContemplations' | 'onCreateContemplation' | 'onUpdateContemplation' | 'onConfirmContemplation' | 'onDeleteContemplation' | 'onProposePrinciple' | 'onListPrincipleProposals' | 'onListPrinciples' | 'onAcceptPrincipleProposal' | 'onRejectPrincipleProposal' | 'onRevisePrincipleStatus'>;
