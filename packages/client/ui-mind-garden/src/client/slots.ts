...
export interface MindGardenDockActions {
  ...
  ) => Promise<MindGardenActionResult>
}
...
export interface MindGardenViewActions extends MindGardenDockActions {
  ...
  onProposeMemory: (
    request: MindGardenMemoryProposeRequest,
  ) => Promise<MindGardenDataResult<MindGardenMemoryItem>>
  /** Confirm one unrelated candidate against the rendered version. */
  onConfirmMemory: (
    item: MindGardenMemoryItem,
    request: WithoutMemoryIdentity<MindGardenMemoryConfirmRequest>,
  ) => Promise<MindGardenDataResult<MindGardenMemoryItem>>
  /** Edit one candidate or active memory against the rendered version. */
  onUpdateMemory: (
    item: MindGardenMemoryItem,
    request: WithoutMemoryIdentity<MindGardenMemoryUpdateRequest>,
  ) => Promise<MindGardenDataResult<MindGardenMemoryItem>>
  ...
  onResolveMemoryRelationship: (
    item: MindGardenMemoryItem,
    request: WithoutMemoryIdentity<MindGardenMemoryResolveRelationshipRequest>,
  ) => Promise<MindGardenDataResult<MindGardenMemoryResolveRelationshipValue>>
  /** Read immutable encrypted before-images for one memory. */
  onListMemoryRevisions: (
    item: MindGardenMemoryItem,
  ) => Promise<MindGardenDataResult<readonly MindGardenMemoryRevision[]>>
  ...
  onSetMemoryAutomationPolicy: (
    policy: MindGardenMemoryAutomationPolicy,
    enabled: boolean,
    minimumCompletedTurns: MindGardenMemoryAutomationInterval,
  ) => Promise<MindGardenDataResult<MindGardenMemoryAutomationPolicy>>
  ...
  onCreatePhotoStory: (
    file: File,
    stamp: MindGardenMediaStamp,
  ) => Promise<MindGardenDataResult<MindGardenPhotoStory>>
  ...
  onCreateConcern: (
    content: string,
    stamp: MindGardenCalendarStamp,
    reminder?: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenConcern>>
  /** Replace one active concern and its optional reminder under CAS. */
  onUpdateConcern: (
    concern: MindGardenConcern,
    content: string,
  ...
  ) => Promise<MindGardenDataResult<MindGardenConcernConversionValue>>
  ...
  onCreateCheckin: (
    ...
    stamp: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenCheckin>>
  ...
  onCreateJournal: (
    ...
    allowRetrieval: boolean,
    stamp: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenJournal>>
  /** Replace one journal's editable fields against the rendered version. */
  onUpdateJournal: (
    journal: MindGardenJournal,
    title: string,
    body: string,
    allowRetrieval: boolean,
  ) => Promise<MindGardenDataResult<MindGardenJournal>>
  ...
  onReflectionTrend: (
    days: 7 | 30,
    endDate: string,
  ) => Promise<MindGardenDataResult<MindGardenReflectionTrendValue>>
  ...
  onCreateExperiment: (
    ...
    action: string,
    stamp: MindGardenCalendarStamp,
    reviewStamp?: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenExperiment>>
  /** Explicitly begin an observed experiment. */
  onStartExperiment: (
    experiment: MindGardenExperiment,
    observedLocalDate: string,
  ) => Promise<MindGardenDataResult<MindGardenExperiment>>
  ...
  onAcceptPrincipleProposal: (
    proposal: MindGardenPrincipleProposal,
    stamp: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenPrinciple>>
  ...
  onRevisePrincipleStatus: (
    principle: MindGardenPrinciple,
    status: MindGardenPrincipleStatus,
    stamp: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenPrinciple>>
  ...
  onCreateOpenQuestion: (
    question: string,
    stamp: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenOpenQuestion>>
  /** Edit or transition one question against the exact rendered version. */
  onUpdateOpenQuestion: (
    question: MindGardenOpenQuestion,
    nextQuestion: string,
    status: MindGardenOpenQuestionStatus,
    stamp: MindGardenCalendarStamp,
  ) => Promise<MindGardenDataResult<MindGardenOpenQuestion>>
  ...
  ) => Promise<MindGardenDataResult<MindGardenPeriodReviewMaterialValue>>
  /** Create one editable proposed review against the material shown to the user. */
  onCreatePeriodReview: (
    material: MindGardenPeriodReviewMaterialValue,
    content: string,
  ) => Promise<MindGardenDataResult<MindGardenPeriodReview>>
  ...
  onUpdatePeriodReview: (
    review: MindGardenPeriodReview,
    content: string,
    status: MindGardenPeriodReviewStatus,
  ) => Promise<MindGardenDataResult<MindGardenPeriodReview>>
}
