...
const PRESETS: Readonly<Record<MindGardenPhotoParticlePreset, Partial<MindGardenPhotoParticleConfig>>> = {
 ...
 */
export function applyPhotoParticlePreset(
  current: MindGardenPhotoParticleConfig,
  preset: MindGardenPhotoParticlePreset,
): MindGardenPhotoParticleConfig {
