...
export const zh = {
  ...
  'star.observer.summon': '召唤星之观察者',
  'star.observer.summon.hint': '抽一张只属于此刻的星卡',
...
export const en = {
  ...
  'star.observer.summon': 'Summon the Star Observer',
  'star.observer.summon.hint': 'Draw one card for this moment',
...
} satisfies Record<MindGardenKey, string>
