...
export type MindGardenBackupErrorCode =
  | 'agent-not-live'
  | 'mind-garden-not-active'
...
export type MindGardenBackupExportResult =
  | { readonly ok: true; readonly value: MindGardenBackupExportValue }
  | { readonly ok: false; readonly error: { readonly code: MindGardenBackupErrorCode } }
...
export type MindGardenBackupRestoreErrorCode =
  | 'agent-not-live'
  | 'mind-garden-not-active'
  | 'durable-session-required'
...
export type MindGardenBackupInspectResult =
  | { readonly ok: true; readonly value: MindGardenBackupInspectValue }
  | { readonly ok: false; readonly error: { readonly code: MindGardenBackupRestoreErrorCode } }

/** Confirmed restore succeeds as an idempotent merge or returns one safe code. */
export type MindGardenBackupRestoreResult =
  | { readonly ok: true; readonly value: MindGardenBackupRestoreValue }
  | { readonly ok: false; readonly error: { readonly code: MindGardenBackupRestoreErrorCode } }
...
export type MindGardenKeyRotationErrorCode =
  | 'agent-not-live'
  | 'mind-garden-not-active'
  | 'durable-session-required'
  | 'confirmation-required'
...
export type MindGardenKeyRotationResult =
  | { readonly ok: true; readonly value: MindGardenKeyRotationValue }
  | { readonly ok: false; readonly error: { readonly code: MindGardenKeyRotationErrorCode } }
