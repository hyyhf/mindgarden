...
import { z } from 'zod';
import { decodeMindGardenStateEvent } from "./fold.js";
/** Runtime schema shared with Host-to-browser projection validation. */
export const mindGardenSessionStateSchema = z.object({
...
export const mindGardenProjectionSchema = z.union([
 ...
 */
export function applyMindGardenProjection(state, event) {
