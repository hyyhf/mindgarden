...
export type MindGardenStarSceneAnswer =
  | '1a' | '1b'
  | '2a' | '2b'
  | '3a' | '3b'
  | '4a' | '4b'
...
export type MindGardenStarTraitStatus =
  | 'self-reported'
  | 'pending'
  | 'confirmed'
  | 'uncertain'
...
export type MindGardenStarEvidenceType =
  | 'daily-reflection'
  | 'confirmed-memory'
  | 'open-question'
  | 'period-review'
...
export type MindGardenStarFailure =
  | MindGardenStarAccessDenied
  | MindGardenStarVaultUnavailable
  | MindGardenStarInvalidField
  | MindGardenStarProfileVersionConflict
  | MindGardenStarRitualCompleted
  | MindGardenStarRitualRequired
  | MindGardenStarTraitNotFound
  | MindGardenStarTraitVersionConflict
  | MindGardenStarTraitLimitReached
  | MindGardenStarObserverModelUnavailable
  | MindGardenStarObserverModelFailed
  | MindGardenStarObserverOutputInvalid
  | MindGardenStarObservationInProgress
  | MindGardenStarActiveCardExists
  | MindGardenStarSourceUnavailable
  | MindGardenStarObserverInputTooLarge
  | MindGardenStarObserverContextChanged
  | MindGardenStarCardNotFound
  | MindGardenStarCardVersionConflict
  | MindGardenStarCardStateConflict
  | MindGardenStarCardRevisionConflict
  | MindGardenStarDialogueLimitReached
...
export type MindGardenStarMapOverviewResult =
  | MindGardenStarSuccess<MindGardenStarMapOverview>
  | MindGardenStarRejected<MindGardenStarAccessDenied | MindGardenStarVaultUnavailable>

/** Result of saving resumable ritual progress. */
export type MindGardenSaveStarRitualResult =
  | MindGardenStarSuccess<MindGardenStarMapOverview>
...
export type MindGardenCompleteStarRitualResult =
  | MindGardenStarSuccess<MindGardenStarMapOverview>
  | MindGardenStarRejected<
    | MindGardenStarAccessDenied
    | MindGardenStarVaultUnavailable
...
export type MindGardenUpdateStarProfileResult =
  | MindGardenStarSuccess<MindGardenStarMapOverview>
  | MindGardenStarRejected<
    | MindGardenStarAccessDenied
    | MindGardenStarVaultUnavailable
...
export type MindGardenUpdateStarTraitResult =
  | MindGardenStarSuccess<MindGardenStarTrait>
  | MindGardenStarRejected<
    | MindGardenStarAccessDenied
    | MindGardenStarVaultUnavailable
    | MindGardenStarInvalidField
...
export type MindGardenDrawStarCardResult =
  | MindGardenStarSuccess<MindGardenStarCard>
  | MindGardenStarRejected<
    | MindGardenStarAccessDenied
    | MindGardenStarVaultUnavailable
    | MindGardenStarInvalidField
...
export type MindGardenCalibrateStarCardResult =
  | MindGardenStarSuccess<MindGardenStarCard>
  | MindGardenStarRejected<
    | MindGardenStarAccessDenied
    | MindGardenStarVaultUnavailable
