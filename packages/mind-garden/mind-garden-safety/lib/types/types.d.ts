...
export type MindGardenSafetyState = 'ordinary' | 'vulnerable' | 'high-risk' | 'urgent' | 'abuse-danger' | 'reality-or-sleep-danger' | 'substance-emergency' | 'support-follow-up';
/** Stable classification explaining why an intervention level was selected. */
export type MindGardenSafetyCategory = 'severe-distress' | 'self-or-other-harm' | 'immediate-danger' | 'abuse-or-child-safety' | 'mania-or-psychosis-danger' | 'overdose-or-withdrawal' | 'safety-follow-up' | 'urgent-follow-up' | 'immediate-danger-reduced' | 'safety-confirmed';
...
export type MindGardenOutputViolation = 'exclusive-dependence' | 'diagnosis' | 'medication-direction' | 'forced-life-decision' | 'trauma-exposure' | 'delusion-confirmation' | 'user-blame' | 'risk-deflection';
