...
export type MindGardenCreatePhotoStoryResult = MindGardenMediaSuccess<MindGardenPhotoStory> | MindGardenMediaRejected<MindGardenMediaAccessDenied | MindGardenMediaVaultUnavailable | MindGardenMediaInvalidField | MindGardenMediaAttachmentRejected | MindGardenMediaAttachmentUnavailable>;
/** Result of listing photo stories. */
export type MindGardenListPhotoStoriesResult = MindGardenMediaSuccess<MindGardenPhotoStoryListValue> | MindGardenMediaRejected<MindGardenMediaAccessDenied | MindGardenMediaVaultUnavailable | MindGardenMediaInvalidField>;
/** Result of reading one story image. */
export type MindGardenReadPhotoStoryResult = MindGardenMediaSuccess<MindGardenPhotoStoryImageValue> | MindGardenMediaRejected<MindGardenMediaAccessDenied | MindGardenMediaVaultUnavailable | MindGardenPhotoStoryNotFound | MindGardenMediaAttachmentUnavailable>;
/** Result of updating one photo story. */
export type MindGardenUpdatePhotoStoryResult = MindGardenMediaSuccess<MindGardenPhotoStory> | MindGardenMediaRejected<MindGardenMediaAccessDenied | MindGardenMediaVaultUnavailable | MindGardenMediaInvalidField | MindGardenPhotoStoryNotFound | MindGardenPhotoStoryVersionConflict>;
/** Result of deleting one photo story. */
export type MindGardenDeletePhotoStoryResult = MindGardenMediaSuccess<MindGardenDeletePhotoStoryValue> | MindGardenMediaRejected<MindGardenMediaAccessDenied | MindGardenMediaVaultUnavailable | MindGardenPhotoStoryVersionConflict>;
/** Result of one explicit, complete image observation. */
export type MindGardenObservePhotoStoryResult = MindGardenMediaSuccess<MindGardenPhotoStory> | MindGardenMediaRejected<MindGardenMediaAccessDenied | MindGardenMediaVaultUnavailable | MindGardenPhotoStoryNotFound | MindGardenPhotoStoryVersionConflict | MindGardenMediaAttachmentUnavailable | MindGardenPhotoModelUnavailable | MindGardenPhotoImageUnsupported | MindGardenPhotoModelFailed | MindGardenPhotoOutputInvalid | MindGardenPhotoModelInProgress | MindGardenPhotoObservationComplete | MindGardenPhotoInputTooLarge>;
/** Result of one complete photo-owned dialogue exchange. */
export type MindGardenContinuePhotoStoryResult = MindGardenMediaSuccess<MindGardenPhotoStory> | MindGardenMediaRejected<MindGardenMediaAccessDenied | MindGardenMediaVaultUnavailable | MindGardenMediaInvalidField | MindGardenPhotoStoryNotFound | MindGardenPhotoStoryVersionConflict | MindGardenPhotoModelUnavailable | MindGardenPhotoModelFailed | MindGardenPhotoOutputInvalid | MindGardenPhotoModelInProgress | MindGardenPhotoObservationRequired | MindGardenPhotoDialogueLimitReached | MindGardenPhotoInputTooLarge>;
