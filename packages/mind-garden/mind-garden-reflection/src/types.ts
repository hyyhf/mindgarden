...
export type MindGardenCalendarEvent =
  | MindGardenCheckin
  | MindGardenJournal
...
export type MindGardenOpenQuestionSource =
  | MindGardenOpenQuestionMessageSource
  | MindGardenOpenQuestionJournalSource
...
export type MindGardenCreateOpenQuestionSource =
  | MindGardenCreateOpenQuestionMessageSource
  | MindGardenCreateOpenQuestionJournalSource
...
export type MindGardenPeriodReviewSourceType =
  | 'checkin'
  | 'journal'
  | 'concern'
  | 'contemplation'
...
export type MindGardenPeriodReviewMaterialCategory =
  | 'events'
  | 'ongoing'
  | 'changes'
  | 'experiments'
...
export type MindGardenReflectionFailure =
  ...
  | MindGardenJournalNotFound
  | MindGardenReflectionVersionConflict
  | MindGardenConcernNotFound
  | MindGardenConcernClosed
  | MindGardenConcernVersionConflict
  | MindGardenContemplationSourceUnavailable
  | MindGardenContemplationNotFound
  | MindGardenContemplationLocked
  | MindGardenContemplationVersionConflict
  | MindGardenPrincipleSourceInvalid
  | MindGardenPrincipleProposalNotFound
  | MindGardenPrincipleProposalClosed
  | MindGardenPrincipleProposalVersionConflict
  | MindGardenPrincipleNotFound
  | MindGardenPrincipleVersionConflict
  | MindGardenPrincipleVersionLimit
  | MindGardenExperimentSourceInvalid
  | MindGardenExperimentNotFound
  | MindGardenExperimentStateConflict
  | MindGardenExperimentVersionConflict
  | MindGardenExperimentObservationLimit
  | MindGardenOpenQuestionSourceInvalid
  | MindGardenOpenQuestionNotFound
  | MindGardenOpenQuestionVersionConflict
  | MindGardenOpenQuestionTransitionLimit
  | MindGardenPeriodReviewSourceRequired
  | MindGardenPeriodReviewSourceLimit
  | MindGardenPeriodReviewMaterialConflict
  | MindGardenPeriodReviewSourceInvalid
  | MindGardenPeriodReviewNotFound
...
export type MindGardenCreateCheckinResult =
  | MindGardenReflectionSuccess<MindGardenCheckin>
  | MindGardenReflectionRejected<MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField>

/** Result of creating one journal. */
export type MindGardenCreateJournalResult =
  | MindGardenReflectionSuccess<MindGardenJournal>
  | MindGardenReflectionRejected<MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField>

/** Result of updating one journal. */
export type MindGardenUpdateJournalResult =
  | MindGardenReflectionSuccess<MindGardenJournal>
...
export type MindGardenDeleteJournalResult =
  | MindGardenReflectionSuccess<MindGardenDeleteJournalValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionVersionConflict
  >

/** Result of creating one concern. */
export type MindGardenCreateConcernResult =
  | MindGardenReflectionSuccess<MindGardenConcern>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of listing concerns. */
export type MindGardenListConcernsResult =
  | MindGardenReflectionSuccess<MindGardenConcernListValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of updating one concern. */
export type MindGardenUpdateConcernResult =
  | MindGardenReflectionSuccess<MindGardenConcern>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenCompleteConcernResult =
  | MindGardenReflectionSuccess<MindGardenConcern>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenConvertConcernResult =
  | MindGardenReflectionSuccess<MindGardenConcernConversionValue>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenCreateContemplationResult =
  | MindGardenReflectionSuccess<MindGardenContemplation>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenListContemplationsResult =
  | MindGardenReflectionSuccess<MindGardenContemplationListValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >
...
export type MindGardenConfirmContemplationResult =
  | MindGardenReflectionSuccess<MindGardenContemplation>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenDeleteContemplationResult =
  | MindGardenReflectionSuccess<MindGardenDeleteContemplationValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenContemplationVersionConflict
  >

/** Result of creating a principle proposal without activating it. */
export type MindGardenProposePrincipleResult =
  | MindGardenReflectionSuccess<MindGardenPrincipleProposal>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenListPrincipleProposalsResult =
  | MindGardenReflectionSuccess<MindGardenPrincipleProposalListValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of explicitly accepting one principle proposal. */
export type MindGardenAcceptPrincipleProposalResult =
  | MindGardenReflectionSuccess<MindGardenPrinciple>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenRejectPrincipleProposalResult =
  | MindGardenReflectionSuccess<MindGardenPrincipleProposal>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenListPrinciplesResult =
  | MindGardenReflectionSuccess<MindGardenPrincipleListValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of appending one directly user-authored principle version. */
export type MindGardenRevisePrincipleResult =
  | MindGardenReflectionSuccess<MindGardenPrinciple>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenCreateExperimentResult =
  | MindGardenReflectionSuccess<MindGardenExperiment>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenListExperimentsResult =
  | MindGardenReflectionSuccess<MindGardenExperimentListValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of explicitly starting a proposed or revised experiment. */
export type MindGardenStartExperimentResult =
  | MindGardenReflectionSuccess<MindGardenExperiment>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenObserveExperimentResult =
  | MindGardenReflectionSuccess<MindGardenExperiment>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenReviseExperimentResult =
  | MindGardenReflectionSuccess<MindGardenExperiment>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenStopExperimentResult =
  | MindGardenReflectionSuccess<MindGardenExperiment>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenCreateOpenQuestionResult =
  | MindGardenReflectionSuccess<MindGardenOpenQuestion>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenListOpenQuestionsResult =
  | MindGardenReflectionSuccess<MindGardenOpenQuestionListValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of editing or transitioning one open question. */
export type MindGardenUpdateOpenQuestionResult =
  | MindGardenReflectionSuccess<MindGardenOpenQuestion>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenOpenQuestionContextResult =
  | MindGardenReflectionSuccess<MindGardenOpenQuestionContextValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of deriving bounded period-review material without making a model request. */
export type MindGardenPeriodReviewMaterialResult =
  | MindGardenReflectionSuccess<MindGardenPeriodReviewMaterialValue>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenCreatePeriodReviewResult =
  | MindGardenReflectionSuccess<MindGardenPeriodReview>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
    | MindGardenReflectionInvalidField
...
export type MindGardenListPeriodReviewsResult =
  | MindGardenReflectionSuccess<MindGardenPeriodReviewListValue>
  | MindGardenReflectionRejected<
    MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField
  >

/** Result of editing or changing the lifecycle of one period review. */
export type MindGardenUpdatePeriodReviewResult =
  | MindGardenReflectionSuccess<MindGardenPeriodReview>
  | MindGardenReflectionRejected<
    | MindGardenReflectionAccessDenied
    | MindGardenReflectionVaultUnavailable
...
export type MindGardenCalendarMonthResult =
  | MindGardenReflectionSuccess<MindGardenCalendarMonthValue>
  | MindGardenReflectionRejected<MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField>

/** Result of reading one day projection. */
export type MindGardenCalendarDayResult =
  | MindGardenReflectionSuccess<MindGardenCalendarDayValue>
  | MindGardenReflectionRejected<MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField>

/** Result of reading one check-in trend. */
export type MindGardenReflectionTrendResult =
  | MindGardenReflectionSuccess<MindGardenReflectionTrendValue>
  | MindGardenReflectionRejected<MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField>

/** Result of reading explicitly authorized reflection context. */
export type MindGardenAuthorizedContextResult =
  | MindGardenReflectionSuccess<MindGardenAuthorizedContextValue>
  | MindGardenReflectionRejected<MindGardenReflectionAccessDenied | MindGardenReflectionVaultUnavailable | MindGardenReflectionInvalidField>
