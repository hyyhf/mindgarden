...
export const storedOpenQuestionSchema = commonSchema.extend({
  ...
  let previousStatus: 'open' | 'resolved' | 'dismissed' | undefined
  let previousCreatedAt = record.createdAt
...
export type StoredReflectionRecord =
  | StoredCheckin
  | StoredJournal
  | StoredConcern
  | StoredContemplation
 ...
 */
export function decodeStoredReflection(value: unknown): StoredReflectionRecord {
