...
export type MindGardenMemoryKind = 'fact' | 'preference' | 'value' | 'support-preference' | 'decision' | 'emotion' | 'episode';
...
export type MindGardenMemoryStatus = 'candidate' | 'confirmed' | 'temporary' | 'rejected' | 'superseded' | 'expired';
...
export type MindGardenMemoryRelationshipResolution = 'keep-existing' | 'keep-both' | 'replace-existing';
...
export type MindGardenMemoryListResult = MindGardenMemorySuccess<MindGardenMemoryListValue> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable>;
/** Result of proposing one confirmation-gated candidate. */
export type MindGardenMemoryProposeResult = MindGardenMemorySuccess<MindGardenMemoryItem> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryFieldBlank | MindGardenMemoryFieldTooLarge | MindGardenMemorySourceInvalid | MindGardenMemoryCredentialLikeContent>;
/** Result of confirming a candidate and selecting its recall policy. */
export type MindGardenMemoryConfirmResult = MindGardenMemorySuccess<MindGardenMemoryItem> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryNotFound | MindGardenMemoryVersionConflict | MindGardenMemoryInvalidTransition | MindGardenMemoryFieldBlank | MindGardenMemoryFieldTooLarge | MindGardenMemoryTemporaryPeriodInvalid | MindGardenMemoryHighSensitivityRecall | MindGardenMemoryCredentialLikeContent | MindGardenMemoryRelationshipReviewRequired>;
...
export type MindGardenMemoryRejectResult = MindGardenMemorySuccess<MindGardenMemoryItem> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryNotFound | MindGardenMemoryVersionConflict | MindGardenMemoryInvalidTransition>;
/** Result of making one memory durably absent. */
export type MindGardenMemoryDeleteResult = MindGardenMemorySuccess<MindGardenMemoryDeleteValue> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryVersionConflict>;
/** Result of reading the addressed Session's latest retrieval audit. */
export type MindGardenMemoryLatestAuditResult = MindGardenMemorySuccess<MindGardenMemoryLatestAuditValue> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable>;
/** Result of explicitly settling one suggested duplicate, contradiction, or refinement. */
export type MindGardenMemoryResolveRelationshipResult = MindGardenMemorySuccess<MindGardenMemoryResolveRelationshipValue> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryNotFound | MindGardenMemoryVersionConflict | MindGardenMemoryInvalidTransition | MindGardenMemoryRelationshipNotPending | MindGardenMemoryRelationshipStale | MindGardenMemoryFieldBlank | MindGardenMemoryFieldTooLarge | MindGardenMemoryTemporaryPeriodInvalid | MindGardenMemoryHighSensitivityRecall | MindGardenMemoryCredentialLikeContent>;
/** Result of reading one memory's encrypted before-image history. */
export type MindGardenMemoryListRevisionsResult = MindGardenMemorySuccess<MindGardenMemoryListRevisionsValue> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryNotFound>;
/** Result of one explicit model-assisted candidate extraction. */
export type MindGardenMemoryExtractResult = MindGardenMemorySuccess<MindGardenMemoryExtractValue> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryExtractionNoSource | MindGardenMemoryExtractionInputTooLarge | MindGardenMemoryExtractionModelUnavailable | MindGardenMemoryExtractionModelFailed | MindGardenMemoryExtractionOutputInvalid | MindGardenMemoryExtractionInProgress>;
/** Result of reading the current Session's newest encrypted extraction audit. */
export type MindGardenMemoryLatestExtractionResult = MindGardenMemorySuccess<MindGardenMemoryLatestExtractionValue> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable>;
/** Result of reading this Session's automatic-extraction authorization. */
export type MindGardenMemoryAutomationPolicyResult = MindGardenMemorySuccess<MindGardenMemoryAutomationPolicy> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable>;
/** Result of replacing this Session's automatic-extraction authorization. */
export type MindGardenMemorySetAutomationPolicyResult = MindGardenMemorySuccess<MindGardenMemoryAutomationPolicy> | MindGardenMemoryRejected<MindGardenMemoryAccessDenied | MindGardenMemoryVaultUnavailable | MindGardenMemoryAutomationVersionConflict>;
